...
Original file is located at
    https://colab.research.google.com/drive/1w5leBaL4l16BpbjRifi1o-L1NkWCmSYK
...
# Import, mount and authorize the use of personal Google Drive (talesmac@gmail.com)
# from google.colab import drive
# drive.mount('/content/drive')
# List all files from your personal google drive
#!ls "/content/drive/My Drive"
# Assign the BPMN's path on Google Drive
# robot_file_path = '/content/drive/MyDrive/UFRJ/MestradoPESC/UAT4PAIS/'
# executed_kw_json_path = '/content/drive/MyDrive/UFRJ/MestradoPESC/UAT4PAIS/executedKeywords.json'
# Friendly Shoulder
# bpmn_path = '/content/drive/MyDrive/UFRJ/MestradoPESC/UAT4PAIS/BPMNandJSONs/FriendlyShoulder/friendlyShoulder.bpmn'
# json_folder_path = '/content/drive/MyDrive/UFRJ/MestradoPESC/UAT4PAIS/BPMNandJSONs/FriendlyShoulder/'
# # TravelPlanXOR
# bpmn_path = '/content/drive/MyDrive/UFRJ/MestradoPESC/UAT4PAIS/BPMNandJSONs/TravelPlanXOR/travel_XOR.bpmn'
# json_folder_path = '/content/drive/MyDrive/UFRJ/MestradoPESC/UAT4PAIS/BPMNandJSONs/TravelPlanXOR/'
# TravelPlanAND
# bpmn_path = '/content/drive/MyDrive/UFRJ/MestradoPESC/UAT4PAIS/BPMNandJSONs/TravelPlanXOR/travel_AND.bpmn'
# json_folder_path = '/content/drive/MyDrive/UFRJ/MestradoPESC/UAT4PAIS/BPMNandJSONs/TravelPlanAND/'
# TravelPlanCOMPLETE
# bpmn_path = '/content/drive/MyDrive/UFRJ/MestradoPESC/UAT4PAIS/BPMNandJSONs/TravelPlanXOR/travel_COMPLETE.bpmn'
# json_folder_path = '/content/drive/MyDrive/UFRJ/MestradoPESC/UAT4PAIS/BPMNandJSONs/TravelPlanCOMPLETE/'
...
robot_file_path = current_directory+'/BPMNandJSONs/FriendlyShoulder/'
