...
# robot -i TC_Random TravelPlanProcessENTITIES2_test.robot
*** Settings ***
Library    FakerLibrary    #locale=pt_BR 
Library    OperatingSystem 
Library    Collections 
Resource    TravelPlanProcessENTITIES2_resources.robot
...
TC_BlindBatch
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-ENTITIES2/executedKeywords-travelPlan-ENTITIES2.json    ${json_string} 
    ${data}=    Evaluate    json.loads(open("C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-ENTITIES2/executedKeywords-travelPlan-ENTITIES2.json").read()) 
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-ENTITIES2/executionsCounter-travelPlan-ENTITIES2.txt    ${output} 
