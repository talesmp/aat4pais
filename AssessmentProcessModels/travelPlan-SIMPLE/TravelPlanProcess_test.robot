...
TC_BlindBatch
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-SIMPLE/executedKeywords-travelPlan-SIMPLE.json    ${json_string} 
    ${data}=    Evaluate    json.loads(open("C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-SIMPLE/executedKeywords-travelPlan-SIMPLE.json").read()) 
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-SIMPLE/executionsCounter-travelPlan-SIMPLE.txt    ${output} 
