...
# robot -i TC_Random TravelPlanProcessXOR_test.robot
*** Settings ***
Library    FakerLibrary    #locale=pt_BR 
Library    OperatingSystem 
Library    Collections 
Resource    TravelPlanProcessXOR_resources.robot
...
TC_BlindBatch
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-XOR/executedKeywords-travelPlan-XOR.json    ${json_string} 
    ${data}=    Evaluate    json.loads(open("C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-XOR/executedKeywords-travelPlan-XOR.json").read()) 
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-XOR/executionsCounter-travelPlan-XOR.txt    ${output} 
