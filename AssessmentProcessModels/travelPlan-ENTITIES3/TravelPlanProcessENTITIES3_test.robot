...
# robot -i TC_Random TravelPlanProcessENTITIES3_test.robot
*** Settings ***
Library    FakerLibrary    #locale=pt_BR 
Library    OperatingSystem 
Library    Collections 
Resource    TravelPlanProcessENTITIES3_resources.robot
...
TC_BlindBatch
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-ENTITIES3/executedKeywords-travelPlan-ENTITIES3.json    ${json_string} 
    ${data}=    Evaluate    json.loads(open("C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-ENTITIES3/executedKeywords-travelPlan-ENTITIES3.json").read()) 
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-ENTITIES3/executionsCounter-travelPlan-ENTITIES3.txt    ${output} 
