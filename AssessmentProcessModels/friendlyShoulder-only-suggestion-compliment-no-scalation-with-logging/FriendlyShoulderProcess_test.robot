...
TC_BlindBatch
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-suggestion-compliment-no-scalation-with-logging/executedKeywords-friendlyShoulder-only-suggestion-compliment-no-scalation-with-logging.json    ${json_string} 
    ${data}=    Evaluate    json.loads(open("C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-suggestion-compliment-no-scalation-with-logging/executedKeywords-friendlyShoulder-only-suggestion-compliment-no-scalation-with-logging.json").read()) 
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-suggestion-compliment-no-scalation-with-logging/executionsCounter-friendlyShoulder-only-suggestion-compliment-no-scalation-with-logging.txt    ${output} 
