...
TC_BlindBatch
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-inclusive-all-types-with-scalation-with-logging/executedKeywords-friendlyShoulder-inclusive-all-types-with-scalation-with-logging.json    ${json_string} 
    ${data}=    Evaluate    json.loads(open("C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-inclusive-all-types-with-scalation-with-logging/executedKeywords-friendlyShoulder-inclusive-all-types-with-scalation-with-logging.json").read()) 
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-inclusive-all-types-with-scalation-with-logging/executionsCounter-friendlyShoulder-inclusive-all-types-with-scalation-with-logging.txt    ${output} 
