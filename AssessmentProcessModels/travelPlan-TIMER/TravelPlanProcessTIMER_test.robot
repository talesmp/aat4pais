...
# robot -i TC_Random TravelPlanProcessTIMER_test.robot
*** Settings ***
Library    FakerLibrary    #locale=pt_BR 
Library    OperatingSystem 
Library    Collections 
Resource    TravelPlanProcessTIMER_resources.robot
...
TC_BlindBatch
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-TIMER/executedKeywords-travelPlan-TIMER.json    ${json_string} 
    ${data}=    Evaluate    json.loads(open("C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-TIMER/executedKeywords-travelPlan-TIMER.json").read()) 
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/travelPlan-TIMER/executionsCounter-travelPlan-TIMER.txt    ${output} 
