...
TC_BlindBatch
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-complaint-no-scalation-no-logging/executedKeywords-friendlyShoulder-only-complaint-no-scalation-no-logging.json    ${json_string} 
    ${data}=    Evaluate    json.loads(open("C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-complaint-no-scalation-no-logging/executedKeywords-friendlyShoulder-only-complaint-no-scalation-no-logging.json").read()) 
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-complaint-no-scalation-no-logging/executionsCounter-friendlyShoulder-only-complaint-no-scalation-no-logging.txt    ${output} 
